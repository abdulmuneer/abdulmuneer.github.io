...
- [Part 1 — What It Is, and How to Run It](./01-what-ignis-is.md) — the artifact and a functional user guide: the in-process design, the `Engine` trait everything hangs off, the repo layout, and how to build and run it.
...
- [Part 3 — Mojo, the Language](./03-mojo-the-language.md) — an assessment of Mojo at 1.0 beta from building in it: where it matured, where it bites, and why batteries-not-included decides fit.
- [Part 4 — MAX, the Platform](./04-max-the-platform.md) — what MAX is and its place among NVIDIA's stack, vLLM/SGLang, and the MLIR compilers; then the deep climax — compiling Ignis's refund policy into the decoder two ways.
